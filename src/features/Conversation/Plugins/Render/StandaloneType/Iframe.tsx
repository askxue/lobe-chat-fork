...
const getMessage = (id: string) =>
  chatSelectors.getMessageById(id)(useChatStore.getState());
...
const IFrameRender = memo<IFrameRenderProps>(
  ({ url, id, payload, width = 600, height = 300 }) => {
    ...
    const createAssistantMessage = useChatStore(
      (s) => s.createAssistantMessageByPlugin
    );

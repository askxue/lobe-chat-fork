export default {
  ...
  response: {
    ...
    InvalidTogetherAIAPIKey:
      'TogetherAI API Key 不正确或为空，请检查 TogetherAI API Key 后重试',
    TogetherAIBizError: '请求 TogetherAI AI 服务出错，请根据以下信息排查或重试',

    ZeroOneBizError: '请求零一万物服务出错，请根据以下信息排查或重试',
    InvalidZeroOneAPIKey:
      '零一万物 API Key 不正确或为空，请检查零一万物 API Key 后重试',
    ...
    InvalidMinimaxAPIKey:
      'Minimax API Key 不正确或为空，请检查 Minimax API Key 后重试',

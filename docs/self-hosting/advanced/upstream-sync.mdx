...
<Callout>
  If you encounter an error when executing `Upstream Sync`, please try executing
  it manually again
</Callout>
...
<Callout type={'warning'}>
  This script can be used in Crontab, but please ensure that your Crontab can
  find the correct Docker command. It is recommended to use absolute paths.
</Callout>

...
<Callout type={'info'}>
  - You can fill in or modify the Redirect URIs after registering, but make sure
  the URL you enter matches the deployed URL. - Please replace "your-domain"
...
<Callout type={'important'}>
  Please make sure to save your client secret as this is your only chance to
  view it.
</Callout>
...
<Callout type={'tip'}>
  ...
  variables](/docs/self-hosting/environment-variable#microsoft-entra-id) for
...
<Callout>
  ...
  LobeChat using the users configured in Microsoft Entra ID.
</Callout>

...
<Image
  ...
  borderless
  src={
    'https://github.com/lobehub/lobe-chat/assets/28616219/52d20fdc-48c0-45e4-9c51-ee150fc18be7'
  }
/>
...
<Callout type={'info'}>
  ...
  was no good frontend TTS library on the market, which resulted in a lot of
  effort being spent on implementation, including data conversion, audio
  progress management, and speech visualization. Adhering to the "Community
  First" concept, we have polished and open-sourced this implementation, hoping
  to help community developers who want to implement TTS.
</Callout>

...
<Image
  ...
  cover
  src={
    'https://github.com/lobehub/lobe-chat/assets/28616219/9eca103c-9335-4a4c-8192-271a0b857b26'
  }
/>
...
<Callout type={'tip'}>
  The default configuration can intelligently identify the user's system color
  mode and automatically switch themes to ensure a consistent visual experience

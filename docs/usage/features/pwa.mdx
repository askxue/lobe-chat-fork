...
<Image
  ...
  cover
  src={
    'https://github.com/lobehub/lobe-chat/assets/28616219/ecc8364a-cfc4-4a3d-b6fd-68b2d9bc5f0d'
  }
/>
...
<Callout type={'important'}>
  On macOS, when using a Chrome-installed PWA, it is required that Chrome be
  open, otherwise Chrome will automatically open and then launch the PWA app.
</Callout>
...
<Callout type={'tip'}>
  The default installed LobeChat PWA icon has a black background, you can use{' '}
  <kbd>cmd</kbd> + <kbd>i</kbd> to paste the following image to replace it with
  a white background.
</Callout>
...
<Image
  ...
  cover
  src={
    'https://github.com/lobehub/lobe-chat/assets/36695271/16ce82cb-49be-4d4d-ac86-4403a1536917'
  }
/>

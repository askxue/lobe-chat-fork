...
<Image
  ...
  cover
  src={
    'https://github.com/lobehub/lobe-chat/assets/34400653/d0d08d98-a8d2-4b97-97c0-24a4f01d7eac'
  }
/>
...
<Callout type={'info'}>
  Groq's LPU Inference Engine achieved a sustained speed of 300 tokens per
  second in internal benchmark tests, and according to benchmark tests by
  ArtificialAnalysis.ai, Groq outperformed other providers in terms of
  throughput (241 tokens per second) and total time to receive 100 output tokens
  (0.8 seconds).
</Callout>
...
<Image
  ...
  inStep
  src={
    'https://github.com/lobehub/lobe-chat/assets/34400653/6942287e-fbb1-4a10-a1ce-caaa6663da1e'
  }
/>
...
<Image
  ...
  inStep
  src={
    'https://github.com/lobehub/lobe-chat/assets/34400653/eb57ca57-4f45-4409-91ce-9fa9c7c626d6'
  }
/>

<Callout type={'warning'}>
  Safely store the key from the pop-up as it will only appear once. If you
  accidentally lose it, you will need to create a new key.
</Callout>
